...
$translation{S_TOOBIGORNONE} = 'Либо это изображение слишком большое либо изображения нет вообще. Такие дела.';
...
$translation{S_NOPOSTING} = 'Постинг временно отключен.';
...
$translation{S_FRIENDS} = "Друзья";
$translation{S_MAINPAGE} = "Главная";
