...
$settings{ENTRIES_PER_LOGPAGE} = 50; 		# Log entries per page
...
$settings{MAX_SHOWN_THREADS} = 120;			 # Maximum number of threads shown (search)
$settings{MAX_SEARCH_RESULTS} = 200;		 # Maximum search results
...
[
	'Adolf', 'Anna', 'Anneliese', 'Alex', 'Alexander', 'Arne',
	'Berta', 'Bertha', 'Burkhard', 'Charlotte', 'Clara', 'Klara',
	'Edith', 'Elfriede', 'Elisabeth', 'Ella', 'Else', 'Emma',
	'Erika', 'Erna', 'Ernst', 'Ernsthard', 'Frieda', 'Frida',
	'Felix', 'Gerda', 'Gertrud', 'Gisela', 'Hedwig', 'Helene',
	'Helga', 'Herta', 'Hertha', 'Hildegard', 'Ida', 'Ilse',
	'Ingeborg', 'Irmgard', 'Johanna', 'Kaete', 'Kaethe', 'Lieselotte',
	'Liselotte', 'Louise', 'Luise', 'Margarethe', 'Margarete', 'Margot',
	'Maria', 'Marie', 'Marta', 'Martha', 'Ruth', 'Ursula',
	'Waltraud', 'Waltraut', 'Alfred', 'Arthur', 'Artur', 'Bruno',
	'Carl', 'Christian', 'Claus', 'Curt', 'Erich', 'Ernst',
	'Franz', 'Friedrich', 'Fritz', 'Georg', 'Gerhard', 'Guenther',
	'Guenter', 'Hans', 'Harry', 'Heinz', 'Helmut', 'Helmuth',
	'Herbert', 'Hermann', 'Horst', 'Joachim', 'Karl', 'Carl',
	'Karlheinz', 'Kai', 'Karl-Heinz', 'Klaus', 'Claus', 'Kurt',
	'Curt', 'Manfred', 'Max', 'Otto', 'Paul', 'Richard',
	'Rudolf', 'Walter', 'Werner', 'Wilhelm', 'Willi', 'Willy',
	'Wolfgang', 'Andrea', 'Angelika', 'Anja', 'Anke', 'Anna',
	'Anne', 'Annett', 'Antje', 'Barbara', 'Birgit', 'Brigitte',
	'Christin', 'Christina', 'Christine', 'Cindy', 'Claudia', 'Daniela',
	'Diana', 'Doreen', 'Franziska', 'Gabriele', 'Heike', 'Ines',
	'Jana', 'Janina', 'Jennifer', 'Jessica', 'Jessika', 'Julia',
	'Juliane', 'Karin', 'Karolin', 'Katharina', 'Kathrin', 'Katrin',
	'Katja', 'Kerstin', 'Klaudia', 'Claudia', 'Klemens', 'Kristin',
	'Christin', 'Laura', 'Lea', 'Lena', 'Lisa', 'Mandy',
	'Manuela', 'Maria', 'Marie', 'Marina', 'Martina', 'Melanie',
	'Monika', 'Nadine', 'Nicole', 'Petra', 'Sabine', 'Sabrina',
	'Sandra', 'Sara', 'Sarah', 'Sascha',  'Silke', 'Simone',
	'Sophia', 'Sophie', 'Stefanie', 'Stephanie',
	'Susanne', 'Tanja', 'Ulrike', 'Ursula', 'Uta', 'Ute',
	'Vanessa', 'Yvonne', 'Alexander', 'Andreas', 'Benjamin', 'Bernd',
	'Christian', 'Daniel', 'David', 'Dennis', 'Dieter', 'Dirk',
	'Dominik', 'Eric', 'Erik', 'Felix', 'Florian', 'Frank',
	'Jan', 'Jens', 'Jonas', 'Joerg', 'Juergen', 'Kevin',
	'Klaus', 'Kristian', 'Christian', 'Leon', 'Lukas', 'Marcel',
	'Marco', 'Marko', 'Mario', 'Marion', 'Markus', 'Martin',
	...
	'Stephan', 'Steffen', 'Sven', 'Swen', 'Siegfried', 'Thomas',
	'Thorsten', 'Torsten', 'Tim', 'Tobias', 'Tom', 'Ulrich',
	'Uwe', 'Vinzent', 'Wolfgang', 'Edeltraud'
];
...
$settings{PREVENT_GHOST_BUMPING} = 1;		# Revert thread lasthit if last post was deleted
$settings{LOG_EXPIRE} = 3600*24*31;			# Admin log expiration
$settings{POST_BACKUP_EXPIRE} = 3600*24*14; # Post backup expiration
...
$settings{POMF_EXTENSIONS} = [qw/mp4 webm xz zip flac mp3 wav/]; # files with those extensions will be uploaded to pomf.cat

# Ban expiration options to be shown in the admin panel.
$settings{BAN_DATES} =
[
	{ label=>'Never', time=>0 },
