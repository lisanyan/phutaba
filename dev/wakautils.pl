...
sub do_spans($@)
{
    ...
    # o trollface
    $line=~s{ (?<![0-9a-zA-Z\*_\x80-\x9f\xe0-\xfc]) (\:trollface\:) (?![0-9a-zA-Z\*_]) }{<img src="/img/trollface.png" alt="Trollgesicht" style="vertical-align: bottom;" />}gx;

    # o zahngrinsen
    $line=~s{ (?<![0-9a-zA-Z\*_\x80-\x9f\xe0-\xfc]) (\:zahngrinsen\:) (?![0-9a-zA-Z\*_]) }{<img src="/img/zahngrinsen.png" alt="Zahngrinsen" style="vertical-align: bottom;" />}gx;
    
    # o eisfee
    $line=~s{ (?<![0-9a-zA-Z\*_\x80-\x9f\xe0-\xfc]) (\:eisfee\:) (?![0-9a-zA-Z\*_]) }{<img src="/img/eisfee.gif" alt="Eisfee" style="vertical-align: bottom;" />}gx;

    # o fffuuuuu
    $line=~s{ (?<![0-9a-zA-Z\*_\x80-\x9f\xe0-\xfc]) (\:fffuuuuu\:) (?![0-9a-zA-Z\*_]) }{<img src="/img/fffuuuuu.png" alt="FFFUUUUU" style="vertical-align: bottom;" />}gx;

    # o fffuuuuu as fu for ppl who cannot count 
    $line=~s{ (?<![0-9a-zA-Z\*_\x80-\x9f\xe0-\xfc]) (\:fu\:) (?![0-9a-zA-Z\*_]) }{<img src="/img/fffuuuuu.png" alt="FFFUUUUU" style="vertical-align: bottom;" />}gx;

    # o the awesome graphic 
    $line=~s{ (?<![0-9a-zA-Z\*_\x80-\x9f\xe0-\xfc]) (\:awesome\:) (?![0-9a-zA-Z\*_]) }{<img src="/img/awesome.png" alt="Awesome" style="vertical-align: bottom;" />}gx;

    # o schreikopf..  
    $line=~s{ (?<![0-9a-zA-Z\*_\x80-\x9f\xe0-\xfc]) (\:kuhlgesicht\:) (?![0-9a-zA-Z\*_]) }{<img src="/img/schreikopf.png" alt="Schreikopf" style="vertical-align: bottom;" />}gx;
...
sub make_date($$;@)
{
	...
	my @fullmonths=qw(Januar Februar M&auml;rz April Mai Juni Juli August September Oktober November Dezember);
...
#		$ltime[3],$ltime[4]+1,$ltime[5]-100,$locdays[$ltime[6]],$ltime[2],$ltime[1]);
		...
		return sprintf("%02d. %s %04d (%s) %02d:%02d:%02d", $day, $fullmonths[$month], $year, $days[$wday], $hour, $min, $sec); 
	}
