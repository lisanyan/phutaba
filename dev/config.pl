...
# System config
use constant ADMIN_PASS => 'CHANGE';			# Admin password. For fucks's sake, change this.
use constant NUKE_PASS => 'XXXXX';			# Password to nuke a board. Change this too, NOW!
use constant SECRET => 'jv45jcdfgdfgdfgdgdsgdgsdg549u8vhhvb';				# Cryptographic secret. CHANGE THIS to something totally random, and long.
use constant SQL_DBI_SOURCE => 'DBI:mysql:database=phutaba1;host=localhost'; # DBI data source string (mysql version, put server and database name in here)
use constant SQL_USERNAME => 'phutaba1';		# MySQL login name
use constant SQL_PASSWORD => 'phutaba1';		# MySQL password
...
use constant SQL_TABLE => 'phutaba_dev';			# Table (NOT DATABASE) used by image board
...
# Page look
use constant TITLE => 'Phutaba 1';	# Name of this image board
...
use constant HOME => '/dev/';					# Site home directory (up one level by default)
...
use constant MAX_RES => 500;					# Maximum topic bumps
...
use constant MAX_SHOWN_THREADS => 1000;
...
use constant HTML_SELF => 'index.php';		# Name of main html file
...
use constant DNSBL_INFOS =>[
            ['tor.dnsbl.sectoor.de', '127.0.0.1', "In DNSBL: tor.dnsbls.sectoor.de"],
            ['torexit.dan.me.uk' ,'127.0.0.100', "In DNSBL: torexit.dan.me.uk"],
            ];
